...
<a href="?mod=khuyenmai&act=add" type="button" class="btn btn-primary">Thêm Khuyến Mãi</a>
<?php } ?>
    ...
    <?php foreach ($data as $row) { ?>
      <tr>
        ...
        <td class="text-center butAction">
          ...
          <a href="?mod=khuyenmai&act=delete&id=<?= $row['MaKM'] ?>" onclick="return confirm('Bạn có thật sự muốn xóa ?');" type="button" class="btn btn-danger">Xóa Khuyến Mãi</a>
          <?php }?>
        </td>
      </tr>
    <?php } ?>
