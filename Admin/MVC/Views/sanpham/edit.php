...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
    <form action="?mod=sanpham&act=update" method="POST" role="form" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="cars">DM Khóa Học: </label>
        ...
        <div class="form-group">
            <label for="cars">Loại Khóa Học: </label>
        ...
        <div class="form-group">
            <label for="">Yêu Cầu khoá học</label>
        ...
        <div class="form-group">
            <label for="">Chương Trình(ngôn ngữ)</label>
            <input type="text" class="form-control" id="" placeholder="" name="Ram" value="<?=$data['Ram']?>">
        </div>
        <div class="form-group">
            <label for="">Hoạt Động Ngoại Khóa</label>
        ...
        <div class="form-group">
            ...
            <input <?=($data['TrangThai']==1)?'checked':''?> type="checkbox" id="" placeholder="" value="1" name="TrangThai"><em>(Check cho phép hiện thị Khóa Học)</em>
        </div>
