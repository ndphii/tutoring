		...
		<div class="row">
			<div class="col-xs-12">
				<div class="pages-title-text text-center">
					<h2 style="color:white">Giỏ Hàng Khóa Học</h2>
					<ul class="text-left">
						<li><a href="?act=home">Trang chủ</a></li>
						<li style="color:white"><span> // Khóa Học Của Bạn </span></li>
					</ul>
				</div>
			</div>
		</div>
...
<div class="col-12" style="padding:0;background-color:#F5F5F5">
    <img src="public/img/wavetim.png" width="100%" height="100%px" style="margin-top: -13px; ">
</div>
<!-- pages-title-end -->
								...
								foreach ($_SESSION['sanpham'] as $value) { ?>
									<tr>
										<td class="td-img text-left" >
											<a href="?act=detail&id=<?= $value['MaSP'] ?>"><img src="public/<?= $value['HinhAnh1'] ?>" alt="Add Product" style="width:100%"/></a>
											<div class="items-dsc">
							...
							<table>
								...
								<tfoot>
									<tr>
										...
										<td class="tfoot-padd"><?=number_format($count+3000)?> VNĐ</td>
									</tr>
								</tfoot>
							</table>
