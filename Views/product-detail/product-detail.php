...
<?php if ($data != null) { ?>
    <div class="pages-title section-padding" style="background: rgba(0, 0, 0, 0) url(public/img/page-title.png) repeat scroll 0 0 !important;">
        <div class="container">
            ...
            .single-product,.img-products{
                 border-radius: 10px 10px 10px 10px;
            }
            .simpleLens-image img {
                width: 100%; 
                height: 280px; 
            }
        </style>
            <div class="row">
                <div class="col-xs-12">
                    <div class="pages-title-text text-center">
                        <h2 style="color:white"><?= $data['TenSP'] ?></h2>
                        <ul class="text-left">
                            <li><a href="?act=home">Trang chủ</a></li>
                            <li><span> // </span><a href="?act=shop">Khóa Học</a></li>
                            <li style="color:white"><span> // <?= $data['TenSP'] ?></span></li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="product-f tab-content">
                                        <?php if ($data['HinhAnh2'] !=  null) { ?>
                                            <div class="simpleLens-container tab-pane fade in" id="sin-1">
                                                <a class="simpleLens-image" data-lens-image="public/<?= $data['HinhAnh2'] ?>" href="#">
                                                    <img src="public/<?= $data['HinhAnh2'] ?>" alt="" class="simpleLens-big-image"></a>
                                            </div>
                                        <?php } ?>
                    ...
                    <div class="col-xs-12 col-sm-7 col-md-8">
                        <div class="quick-right">
                            <div class="list-text">
                                ...
                                <?php if (!empty($data['MaDM'])) { ?>
                                    <p style="margin-bottom: -10px !important"><?= $data['MoTa'] ?></p>
                                <?php }?>
                                <div class="list-btn " style="margin-top:100px !important" >
                                    <a href="?act=cart&xuli=add&id=<?=$data['MaSP']?>">Đăng Ký Khóa Học</a>
                                    <?php if (!empty($data['MaDM'])) { ?>
                                    <a href="#info">Chi tiết khóa học</a>
                                    <?php }?>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xs-12">
                    <div class="reviews padding60 margin-top">
                        <ul class="reviews-tab clearfix" id="info">
                            <?php if (!empty($data['MaDM'])) { ?>
                                <li class="active"><a data-toggle="tab" href="#moreinfo" >Thông Tin</a></li>
                            <?php } ?>
                            <li><a data-toggle="tab" href="#reviews">Đánh giá khóa học</a></li>
                        </ul>
                        <div class="tab-content">
                            <?php if (!empty($data['MaDM'])) { ?>
                                <div class="info-reviews moreinfo tab-pane fade in active" id="moreinfo">
                                    <div class="tb">
                                        <h5>Thông Chi Tiết KHóa Học</h5>
                                        <ul>
                                            <li>
                                                <span>Yều Cầu khoá học</span>
                                            ...
                                            <li>
                                                <span>Chương Trình(ngôn ngữ)</span>
                                                <div><?= $data['Ram'] ?></div>
                                            </li>
                                            <li>
                            ...
                            <?php } ?>
                            <div class="<?php if (!empty($data['MaDM'])) {
