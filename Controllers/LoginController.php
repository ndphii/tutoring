...
class LoginController
{
    ...
    function dangky()
    {
        ...
        $mail= new Mailer();
        $tieude="Đăng Ký Tài Khoản Kids TuTo Trung Tâm Dạy Thêm";
        date_default_timezone_set("Asia/Ho_Chi_Minh");
        $body="<p>Bạn Đã Đăng Ký Tài Khoản Thành Công Vào Lúc <b>".date("Y-m-d h:i:sa")."</b> Tại Trung Tâm Dạy Thêm KIDS_TUTO</p>";
        $mail->RegMail($_POST['Email'],$_POST['Ten'],$tieude,$body);
